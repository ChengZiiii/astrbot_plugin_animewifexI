...
- 💔 **离婚系统**：老婆离婚返还公式 + 双向平分家产(±200封顶) + 7天冷却 + 二次确认
- 💳 **负债经济**：余额可达-500、0利息、优先抵债、打工/商城负债限制
- 🪙 **NTR 安慰币**：攻击者零代价、被牛方获安慰币(与离婚返还基础对齐)、复仇免费
- **完整改动**：PK v2 全程（编队/速度/被动/状态/换人/超时）、离婚全程、负债全程、NTR 零代价 + 安慰币 + 面板 NTR 统计
- **验证**：749 单元测试通过、7 个 QA 脚本全部通过
